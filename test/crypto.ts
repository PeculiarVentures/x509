...
describe("crypto", () => {
  ...
  describe("PemData", () => {
    describe("from string buffer", () => {
      let hex: BufferSourceLike;
      let pem: BufferSourceLike;
      let base64: BufferSourceLike;
      let base64url: BufferSourceLike;
      ...
      beforeAll(() => {
        ...
        const csr = new x509.Pkcs10CertificateRequest(encoding.base64.decode(pemString));
        pem = encoding.binary.decode(csr.toString("pem"));
        hex = encoding.binary.decode(csr.toString("hex"));
        base64 = encoding.binary.decode(csr.toString("base64"));
        base64url = encoding.binary.decode(csr.toString("base64url"));
      });
  ...
  describe("Pkcs10CertificateRequest", () => {
    it("read", () => {
      ...
      const csr = new x509.Pkcs10CertificateRequest(encoding.base64.decode(pem));
...
-----END CERTIFICATE-----`;
    ...
    it("read", () => {
      const cert = new x509.X509Certificate(encoding.base64.decode(pem));
    ...
    describe("thumbprint", () => {
      it("default", async () => {
        ...
        expect(encoding.hex.encode(thumbprint)).toBe("0cfbca8d79cdc989e4dd64abbc2f979cc9e0ccb4");
      });

      it("SHA-256", async () => {
        const cert = new x509.X509Certificate(encoding.base64.decode(pem));
        const thumbprint = await cert.getThumbprint("SHA-256");
        expect(encoding.hex.encode(thumbprint)).toBe("3578985ded3c684a00d138596cadc96a37eb2dd01511b4b7b7135a55362153df");
      });
...
-----END CERTIFICATE-----`);
  ...
  describe("PublicKey", () => {
    const spki = encoding.hex.decode("");
    ...
    describe("getThumbprint", () => {
      it("default", async () => {
        ...
        expect(encoding.hex.encode(thumbprint)).toBe("dd0137099d08ab3324e183ec258413d1b79e95b0");
      });

      it("SHA-256", async () => {
        const key = new x509.PublicKey(spki);
        const thumbprint = await key.getThumbprint("SHA-256");
        expect(encoding.hex.encode(thumbprint)).toBe("5bdf9c42c2d13d8edfb7733c257f49ec7d8ac20d2dbe36a693e92b84a26c845c");
      });
  ...
  describe("X509Certificates", () => {
    ...
    describe("import/export", () => {
      ...
      it("hex", async () => {
        ...
        expect(encoding.hex.is(hex)).toBe(true);
      ...
      it("base64", async () => {
        ...
        expect(encoding.base64.is(base64)).toBe(true);
      ...
      it("base64url", async () => {
        ...
        expect(encoding.base64url.is(base64url)).toBe(true);
  ...
  describe("Extensions", () => {
    it("Subject Alternative Name", () => {
      ...
      const san = new x509.SubjectAlternativeNameExtension(encoding.hex.decode(hex));
      ...
      const hex2 = encoding.hex.encode(san2.rawData);
...
-----END CERTIFICATE-----`;
  ...
  describe("X509Crl", () => {
    ...
    it("read", () => {
      const crl = new x509.X509Crl(encoding.base64.decode(pem));
    ...
    it("verify", async () => {
      ...
      const cert = new x509.X509Certificate(encoding.base64.decode(goodCACert));
      const crl = new x509.X509Crl(encoding.base64.decode(pem));

      const ok = await crl.verify({ publicKey: cert });
      expect(ok).toBe(true);

      const cert2 = new x509.X509Certificate(encoding.base64.decode(badCACert));
  ...
  describe("X509 crl generator", () => {
    ...
    it("generate ca and crl", async () => {
      ...
      const crlBase = new x509.X509Crl(encoding.base64.decode(pem));
