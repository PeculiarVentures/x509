...
export enum ChainRuleType {
  critical = "critical",  //critical - ошибка, которая приводит к прерыванию проверки и установке статуса "invalid"
  error = "error",     //error - ошибка, которая не приводит к прерыванию проверки и установке статуса "invalid"
  notice = "notice",    //warning - предупреждение, которое не приводит к прерыванию проверки и не меняет статус
  warning = "warning",   //notice - информационное сообщение, которое не приводит к прерыванию проверки и не меняет статус
}
